# Software Testing Hodoku Maven
This project is a clone (with some minor changes to get compilation to work) of the Sudoku for Java - HoDoKu Code project from the SourceForge website: https://sourceforge.net/p/hodoku/code/HEAD/tree/
