 ...
 * default main.java.solver and reports the progress to the dialog. If a puzzle has been
...
public class BackgroundGenerator {
     ...
     * {@link #generate(DifficultyLevel, GameMode, sudoku.GenerateSudokuProgressDialog) }.
     * 
     * @param level
     * @param mode
     * @return 
    ...
    public Sudoku2 generate(DifficultyLevel level, GameMode mode, GenerateSudokuProgressDialog dlg) {
        ...
        if (dlg == null) {
            ...
            // use the default main.java.solver
