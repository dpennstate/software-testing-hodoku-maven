 ...
 * threads an arbitrary number of additional main.java.generator instances can be gotten
...
public class SudokuGeneratorFactory {
    ...
    private static class generatorInstance {
        /** The main.java.generator held in this entry. */
        SudokuGenerator instance = null;
        /** <code>true</code>, if the main.java.generator has been handed out by the factory. */
        boolean inUse = true;
        /** Last time the main.java.generator was returned to the factory. */
        long lastUsedAt = -1;
    ...
    /**
     * Hand out an ununsed main.java.generator or create a new one if necessary.
     * @return
     */
    ...
    /**
     * Gives a main.java.generator back to the factory.
     * @param generator
     */
