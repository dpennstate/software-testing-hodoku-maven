...
public abstract class AbstractSolver {
    /** The {@link SudokuStepFinder} to which this specialized main.java.solver belongs. */
    protected SudokuStepFinder finder;
    /** Every main.java.solver needs the sudoku... */
...
//    private SudokuSet tmpSet = new SudokuSet();
     ...
     * data structures. If a main.java.solver wants to use this functionality,
