...
//        System.out.println(tmpBuffer);
    ...
    private SolutionStep getAnyFish(int size, boolean withoutFins,
        ...
        if (finder.getStepNumber() != lastStepNumber) {
            // main.java.sudoku is dirty -> cache is useless
            cachedSteps.clear();
...
//        Sudoku2 main.java.sudoku = new Sudoku2();
//        // X-Wing: 3 r37 c34 => r1c34,r4c34,r5c34,r6c34,r9c4<>3
//        main.java.sudoku.setSudoku(":0300:3:9.....+5+6+1..+6.+1.7+937+1..962486...2+147+9........5....4...642..+586+1+75.71.+2..+4..1....+52::313 314 343 344 353 354 363 364 394::");
////        // X-Wing: 1 c15 r25 => r2c4789,r5c34789<>1
//        main.java.sudoku.setSudoku(":0300:1:9+8..627+5+3.+65..3...+3+2+7.+5...67+9..3.+5...+5...9...8+32.45..9+6+735+91+428+24+9.+8+7..5+51+8.+2...+7::124 127 128 129 153 154 157 158 159::");
////        // X-Wing: 7 c28 r47 => r4c1345,r7c1345<>7
//        main.java.sudoku.setSudoku(":0300:7:....+827...3...+1+8....8..7.9......+8..58+5...+4.6..6.1.59+84.....+3..8.45+819.3..+834.+651+9::741 743 744 745 771 773 774 775::");
////        // Jellyfish: 8 r1468 c2679 => r235c2,r39c7,r9c9<>8
//        main.java.sudoku.setSudoku(":0302:8:+65+4.+2..7+12..+1.+7+5+46..+1456..+2+1+27+63.4+5...65.12.+7+5.9+27.1+6...+5812...9.+2....+15.1...+5.2.:317 331 332 997 999:822 832 837 852 897 899::");
////        // Finned X-Wing: 9 r48 c38 fr8c7 => r7c8<>9
//        main.java.sudoku.setSudoku(":0310:9:..3..+67......91..+3.6...3.597+8.+25+43.+1...+3+1+7.8+22+3+16+89+4+75+6.813+2...+32.4+7...6...+9+6.23.::978::");
////        // Finned Swordfish: 4 c168 r247 fr1c6 => r2c4<>4
//        main.java.sudoku.setSudoku(":0311:4:.3.2+6..+8.86..3.5.+2.+2487..+3+6.+8.39.+2.72..6.8..31.+3+527.+6...+2.863..+3.8.5+2+691.....3.2.:924 128 448 452 157 458 578 491 591 792 193 793:424::");
////        // Finned Jellyfish: 7 r1569 c4689 fr9c7 => r7c9<>7
//        main.java.sudoku.setSudoku(":0312:7:+6.+4.5.9.2.596.+2.+4+8....+94.+56578+2+4+9..3+2+46.1.5..9+1+3.+6.8244..9+8.+2.......648.8.1+42...+5:314 754 756 376 776 178 778 382 783 384 784 789 398:779::");
////        // Franken Swordfish: 8 r236 c24b3 => r7c2<>8
//        main.java.sudoku.setSudoku(":0331:8:52...617.174.536..6.9271..5..5.2...6.9.76..1...6.3...4..759236135261.9.79613.7.5.:814 819 928 842 844 944 856 861 964 866 867 868:872::");
////        // Sashimi Jellyfish: 6 r1269 c5678 fr9c4 => r7c56<>6
//        main.java.sudoku.setSudoku(":0322:6:..+12.5....254+1....6.....1+5+2+2..1+5..7.5.....9.+1.+138...+25...+5..+21.15.+3..79..82.7+1+5.3:411 412 815 419 619 819 826 629 829 833 447 647 849 458 658 685 686:675 676::");
////        // Finned X-Wing: 3 r24 c15 fr2c6 => r13c5<>3
//        main.java.sudoku.setSudoku(":0310:3:1.........5.....61..8+1..2...7...9.......1.3..4...5...6.+6.+398+14+2+9+42+5+71+6..+8+136+4279+5:962:315 335::");
////        // Finned Franken Jellyfish: 3 r348b1 c3459 fr1c1 fr3c8 => r1c9<>3
////        main.java.sudoku.setSudoku(":0342:3:..+5+648+1..+4...1.+6.86+1+8..75.+4+5+42..186.7+8+6...4.193+1...+7+521+6....34+5+85....+21+7..4+1..+9+86:218 918 222 923 924 344 955 386 986 295 296:319::");
////        // Finned Franken Jellyfish: 7 r169b3 c2679 fr6c8 efr1c9 => r5c9<>7
////        main.java.sudoku.setSudoku(":0342:7:+5.3+9641+8..+1.+5...69.9+6...53+4..7...84515.4........3+5...+1..+5.+4..1...18.54.+66..21..+58::759::");
////        // Finned Mutant Jellyfish: 4 r36c15 r18c6b4 fr3c9 => r1c9<>4
////        main.java.sudoku.setSudoku(":0362:4:.7+6+1.95..1..+6.5...+98+5+72.16.+7...1+6.......97.3.6+9.2+5.+7188.7.6..5...9+5..3.....+9...4.:211 319 425 227 228 229 443 449 172 272 376 476 885 286 486 289 895 396:419::");
//        // X-Wing: 1 c15 r25 => r2c4789,r5c34789<>1 (checks recursion)
//        main.java.sudoku.setSudoku(":0300:1:9+8..627+5+3.+65..3...+3+2+7.+5...67+9..3.+5...+5...9...8+32.45..9+6+735+91+428+24+9.+8+7..5+51+8.+2...+7::124 127 128 129 153 154 157 158 159:c15 r25");
////        main.java.sudoku.setSudoku("");
////        main.java.sudoku.setSudoku("");
////        main.java.sudoku.setSudoku("");
//        SudokuSolver main.java.solver = SudokuSolverFactory.getDefaultSolverInstance();
//        boolean singleHint = true;
//        if (singleHint) {
//            SolutionStep step = main.java.solver.getHint(main.java.sudoku, false);
//            System.out.println(step);
//        } else {
//            List<SolutionStep> steps = main.java.solver.getStepFinder().getAllFishes(main.java.sudoku, 2, 2, 0, 0, null, 1, BASIC);
//            main.java.solver.getStepFinder().printStatistics();
//            if (steps.size() > 0) {
//                Collections.sort(steps);
