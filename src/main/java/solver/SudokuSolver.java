...
public class SudokuSolver {
     ...
     * it starts the main.java.solver in a seperate thread. If the thread does not complete
...
//        boolean solved = solve(Options.getInstance().getDifficultyLevels()[DifficultyType.EXTREME.ordinal()], null, false, null, true);
    ...
    /**
     * The real main.java.solver method. Can reject a possible solution if the {@link DifficultyLevel}
...
//            System.out.println("        rejected: puzzle not solved!");
     ...
     * (see {@link #getProgressScoreSingles(Sudoku2, SolutionStep) }).
     * @param tmpSudoku
     * @param stepsTocheck 
     * @param dlg
     */
...
//                System.out.println("       " + tmpSudoku.getSudoku(ClipboardMode.LIBRARY));
     ...
     * The current state of the main.java.solver instance is saved and restored after the search
     * is complete.
     * @param sudoku
     * @param singlesOnly
     * @return
...
//            }
    ...
    /**
     * Prints runtime statistics for main.java.solver
     * @param out
     */
