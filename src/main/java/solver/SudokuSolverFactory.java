 ...
 * threads an arbitrary number of additional main.java.solver instances can be gotten
...
public class SudokuSolverFactory {
    ...
    private static class SolverInstance {
        /** The main.java.solver held in this entry. */
        SudokuSolver instance = null;
        /** <code>true</code>, if the main.java.solver has been handed out by the factory. */
        boolean inUse = true;
        /** Last time the main.java.solver was returned to the factory. */
        long lastUsedAt = -1;
    ...
    /**
     * Hand out an ununsed main.java.solver or create a new one if necessary.
     * @return
     */
    ...
    /**
     * Gives a main.java.solver back to the factory.
     * @param solver
     */
