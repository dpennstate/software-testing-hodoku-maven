 ...
 * <li>It caches data needed by more than one main.java.solver (e.g. ALS and RCs)</li>
...
public class SudokuStepFinder {
    ...
    /** The specialized main.java.solver for Singles, Intersections and Subsets. */
    private SimpleSolver simpleSolver;
    /** The specialized main.java.solver for all kinds of Fish. */
    private FishSolver fishSolver;
    /** The specialized main.java.solver for single digit patterns. */
    private SingleDigitPatternSolver singleDigitPatternSolver;
    /** The specialized main.java.solver for all kinds of Uniqueness techniques. */
    private UniquenessSolver uniquenessSolver;
    /** The specialized main.java.solver for Wings. */
    private WingSolver wingSolver;
    /** The specialized main.java.solver for Coloring. */
    private ColoringSolver coloringSolver;
    /** The specialized main.java.solver for simple chains. */
    private ChainSolver chainSolver;
    /** The specialized main.java.solver for ALS moves. */
    private AlsSolver alsSolver;
    /** The specialized main.java.solver for SDC. */
    private MiscellaneousSolver miscellaneousSolver;
    /** The specialized main.java.solver for complicated chains. */
    private TablingSolver tablingSolver;
    /** The specialized main.java.solver for Templates. */
    private TemplateSolver templateSolver;
    /** The specialized main.java.solver for guessing. */
    private BruteForceSolver bruteForceSolver;
    /** The specialized main.java.solver for Incomplete Solutions. */
    private IncompleteSolver incompleteSolver;
    /** The specialized main.java.solver for giving up. */
    ...
    // Data that is used by more than one specialized main.java.solver
...
//        SudokuSetBase temp = new SudokuSetBase();
     ...
     * The work is delegated to {@link #collectAllAlsesForHouse(int[][], Sudoku2, List, boolean)}.<br><br>
    ...
    /**
     * Lists of all RCs of the current sudoku are needed by more than one main.java.solver,
