...
//        stepsTree.setCellRenderer(new ScalableRenderer());
    ...
    private void initComponents() {
        ...
        addToSolutionButton = new JButton();
        jScrollPane1 = new JScrollPane();
        stepsTree = new JTree();
        jToolBar1 = new JToolBar();
        configureButton = new JButton();
        jSeparator1 = new JToolBar.Separator();
        directSingleSortToggleButton = new JToggleButton();
        singleSortToggleButton = new JToggleButton();
        cellSortToggleButton = new JToggleButton();
        eliminationSortToggleButton = new JToggleButton();
        typeSortToggleButton = new JToggleButton();

        setLayout(new BorderLayout());

        findButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.findButton.mnemonic").charAt(0));
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/AllStepsPanel"); // NOI18N
        ...
        addToSolutionButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.addToSolution.mnemonic").charAt(0));
        ...
        jPanel2Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {addToSolutionButton, findButton});
        // Danny: Fixed Group Error Specifically Here
        ...
        configureButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/settings.png"))); // NOI18N
        ...
        configureButton.setMaximumSize(new Dimension(36, 36));
        ...
        directSingleSortToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/search_d1.png"))); // NOI18N
        ...
        directSingleSortToggleButton.setHorizontalTextPosition(SwingConstants.CENTER);
        directSingleSortToggleButton.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        singleSortToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/search_s1.png"))); // NOI18N
        ...
        singleSortToggleButton.setHorizontalTextPosition(SwingConstants.CENTER);
        singleSortToggleButton.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        cellSortToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/search_c1.png"))); // NOI18N
        ...
        cellSortToggleButton.setHorizontalTextPosition(SwingConstants.CENTER);
        cellSortToggleButton.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        eliminationSortToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/search_e1.png"))); // NOI18N
        ...
        eliminationSortToggleButton.setHorizontalTextPosition(SwingConstants.CENTER);
        eliminationSortToggleButton.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        typeSortToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/search_t1.png"))); // NOI18N
        ...
        typeSortToggleButton.setHorizontalTextPosition(SwingConstants.CENTER);
        typeSortToggleButton.setVerticalTextPosition(SwingConstants.BOTTOM);
    ...
    private void addToSolutionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToSolutionButtonActionPerformed
        ...
        if (last != null) {
            if (last.getUserObject() instanceof String) {
                ...
                // Danny: Fixed Enumeration Error Here
        ...
        if (actStep == null) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.no_solution_selected"),
                    ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void findButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findButtonActionPerformed
        if (sudoku == null) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.sudoku_not_set"),
                    ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        resetTreeNodes();
    ...
    public void resetPanel() {
        model = new DefaultTreeModel(new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.no_solutions")));
        steps = null;
    ...
    private void resetTreeNodes() {
        ...
        root.setUserObject(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.searching"));
        model.reload();
    ...
    private void createTreeNodes(int sortMode) {
        ...
        if (steps == null || steps.isEmpty()) {
            root.setUserObject(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.no_solution"));
            stepsTree.setRootVisible(true);
            model.reload();
            stepsTree.repaint();
            return;
    ...
    private void createTreeNodesTypes(DefaultMutableTreeNode root) {
        ...
        // now build the tree
        root.setUserObject(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.possible_steps"));
    ...
    private void createTreeNodesCells(DefaultMutableTreeNode root) {
        ...
        for (Entry<Integer, List<SolutionStep>> entry : map.entrySet()) {
            ...
            // new candidate
            lastCat2 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.candidate") +
                    " " + candidate);
    ...
    private void createTreeNodesSingles(DefaultMutableTreeNode root) {
        ...
        for (SolutionStep step : steps) {
            ...
            if (lastStep == null || step.getProgressScoreSingles() != lastStep.getProgressScoreSingles()) {
                // new top category
                lastCat1 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.singles") +
                        " " + step.getProgressScoreSingles());
                root.add(lastCat1);
                lastCat2 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.score") +
    ...
    private void createTreeNodesDirectSingles(DefaultMutableTreeNode root) {
        ...
        for (SolutionStep step : steps) {
            ...
            if (lastStep == null || step.getProgressScoreSinglesOnly() != lastStep.getProgressScoreSinglesOnly()) {
                // new top category
                lastCat1 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.direct_singles") +
                        " " + step.getProgressScoreSinglesOnly());
                root.add(lastCat1);
                lastCat2 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.singles") +
                        " " + step.getProgressScoreSingles());
                lastCat1.add(lastCat2);
                lastCat3 = new DefaultMutableTreeNode(ResourceBundle.getBundle("main/resources/intl/AllStepsPanel").getString("AllStepsPanel.score") +
                        " " + step.getProgressScore());
