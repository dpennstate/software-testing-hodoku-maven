...
//    private Sudoku2 solvedSudoku;
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog"); // NOI18N
        ...
        cellsCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchPanel.cellsCheckBox.mnemonic").charAt(0));
        ...
        candidatesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchPanel.candidatesCheckBox.mnemonic").charAt(0));
        ...
        candLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchPanel.candLabel.mnemonic").charAt(0));
        ...
        resultPanelLayout.setVerticalGroup(
            resultPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(resultPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addGroup(resultPanelLayout.createSequentialGroup()
        ...
        startButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.startButton.mnemonic").charAt(0));
        ...
        closeButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.stopButton.mnemonic").charAt(0));
        ...
        stopButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.closeButton.mnemonic").charAt(0));
    ...
    public void setVisible(boolean visible) {
        if (visible) {
            ...
            if (anz <= 16) {
                JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.error.message") + " (" + anz + ")",
                        ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.error.title"), JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
...
//        System.out.println("Thread started!");
        ...
        // normal end
        setFinished(true);
        triggerUpdateProgressbar(ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.searchLabel.text"), 100, 100);
        EventQueue.invokeLater(updateRunnable);
...
//            System.out.println("adjust: stopped");
    ...
    private boolean checkCandidates(int depth, int max, List<Candidate> candidates, StepConfig[] stepConfigs)
        ...
        int counter = 0;
        String startStr = ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_candidates") + " (";
        if (stepConfigs == null) {
            startStr += ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.singles");
        } else {
            startStr += ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.progress");
        }
        startStr += " - ";
        String label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_candidates1");
        if (depth == 2) {
            label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_candidates2");
        } else if (depth == 3) {
            label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_candidates3");
        }
        label += ")";
        for (int i = 0; i < end; i++) {
            if (depth == 1) {
    ...
    private boolean checkSingles(int depth, int max, StepConfig[] stepConfigs)
        ...
        int counter = 0;
        String startStr = ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_cells") + " (";
        if (stepConfigs == null) {
            startStr += ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.singles");
        } else {
            startStr += ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.progress");
        ...
        startStr += " - ";
        String label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_cells1");
        if (depth == 2) {
            label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_cells2");
        } else if (depth == 3) {
            label = startStr + ResourceBundle.getBundle("main/resources/intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_cells3");
        }
        label += ")";
        for (int i = 0; i < end; i++) {
