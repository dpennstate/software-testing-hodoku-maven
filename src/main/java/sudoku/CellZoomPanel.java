...
//        System.out.println("jFOntButton: " + defaultButtonHeight + "/" + metrics.getHeight() + "/" + buttonFontSize + "/" + buttonFont + "/" + iconFont);
    ...
    private void initComponents() {
        ...
        setValueButton1 = new JButton();
        setValueButton2 = new JButton();
        setValueButton3 = new JButton();
        setValueButton4 = new JButton();
        setValueButton5 = new JButton();
        setValueButton6 = new JButton();
        setValueButton7 = new JButton();
        setValueButton8 = new JButton();
        setValueButton9 = new JButton();
        toggleCandidatesLabel = new JLabel();
        toggleCandidatesPanel = new JPanel();
        toggleCandidatesButton1 = new JButton();
        toggleCandidatesButton2 = new JButton();
        toggleCandidatesButton3 = new JButton();
        toggleCandidatesButton4 = new JButton();
        toggleCandidatesButton5 = new JButton();
        toggleCandidatesButton6 = new JButton();
        toggleCandidatesButton7 = new JButton();
        toggleCandidatesButton8 = new JButton();
        toggleCandidatesButton9 = new JButton();
        cellColorLabel = new JLabel();
        cellColorPanel = new JPanel();
        chooseCellColorPanel = new JPanel();
        ...
        chooseCandidateColorLabel = new JLabel();
        candidateColorPanel = new JPanel();
        chooseCandidateColorPanel = new JPanel();
        ...
        toggleCandidatesLabel.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        toggleCandidatesPanel.setLayout(new GridLayout(3, 3));
        ...
        cellColorLabel.setHorizontalAlignment(SwingConstants.CENTER);
        cellColorLabel.setText(bundle.getString("CellZoomPanel.colorCellsLabel.text")); // NOI18N
        add(cellColorLabel);
        cellColorLabel.setBounds(0, 0, 105, 14);

        cellColorPanel.setBackground(new Color(255, 255, 255));
        cellColorPanel.setBorder(BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));

        GroupLayout cellColorPanelLayout = new GroupLayout(cellColorPanel);
        cellColorPanel.setLayout(cellColorPanelLayout);
        cellColorPanelLayout.setHorizontalGroup(
            cellColorPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        chooseCellColorPanel.setLayout(new GridLayout(2, 6, 1, 1));
        ...
        GroupLayout chooseCellColor0PanelLayout = new GroupLayout(chooseCellColor0Panel);
        chooseCellColor0Panel.setLayout(chooseCellColor0PanelLayout);
        chooseCellColor0PanelLayout.setHorizontalGroup(
            chooseCellColor0PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        GroupLayout chooseCellColor2PanelLayout = new GroupLayout(chooseCellColor2Panel);
        chooseCellColor2Panel.setLayout(chooseCellColor2PanelLayout);
        chooseCellColor2PanelLayout.setHorizontalGroup(
            chooseCellColor2PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor4PanelLayout = new GroupLayout(chooseCellColor4Panel);
        chooseCellColor4Panel.setLayout(chooseCellColor4PanelLayout);
        chooseCellColor4PanelLayout.setHorizontalGroup(
            chooseCellColor4PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor6PanelLayout = new GroupLayout(chooseCellColor6Panel);
        chooseCellColor6Panel.setLayout(chooseCellColor6PanelLayout);
        chooseCellColor6PanelLayout.setHorizontalGroup(
            chooseCellColor6PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor8PanelLayout = new GroupLayout(chooseCellColor8Panel);
        chooseCellColor8Panel.setLayout(chooseCellColor8PanelLayout);
        chooseCellColor8PanelLayout.setHorizontalGroup(
            chooseCellColor8PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColorM1PanelLayout = new GroupLayout(chooseCellColorM1Panel);
        chooseCellColorM1Panel.setLayout(chooseCellColorM1PanelLayout);
        chooseCellColorM1PanelLayout.setHorizontalGroup(
            chooseCellColorM1PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor1PanelLayout = new GroupLayout(chooseCellColor1Panel);
        chooseCellColor1Panel.setLayout(chooseCellColor1PanelLayout);
        chooseCellColor1PanelLayout.setHorizontalGroup(
            chooseCellColor1PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor3PanelLayout = new GroupLayout(chooseCellColor3Panel);
        chooseCellColor3Panel.setLayout(chooseCellColor3PanelLayout);
        chooseCellColor3PanelLayout.setHorizontalGroup(
            chooseCellColor3PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor5PanelLayout = new GroupLayout(chooseCellColor5Panel);
        chooseCellColor5Panel.setLayout(chooseCellColor5PanelLayout);
        chooseCellColor5PanelLayout.setHorizontalGroup(
            chooseCellColor5PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor7PanelLayout = new GroupLayout(chooseCellColor7Panel);
        chooseCellColor7Panel.setLayout(chooseCellColor7PanelLayout);
        chooseCellColor7PanelLayout.setHorizontalGroup(
            chooseCellColor7PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColor9PanelLayout = new GroupLayout(chooseCellColor9Panel);
        chooseCellColor9Panel.setLayout(chooseCellColor9PanelLayout);
        chooseCellColor9PanelLayout.setHorizontalGroup(
            chooseCellColor9PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCellColorM2PanelLayout = new GroupLayout(chooseCellColorM2Panel);
        chooseCellColorM2Panel.setLayout(chooseCellColorM2PanelLayout);
        chooseCellColorM2PanelLayout.setHorizontalGroup(
            chooseCellColorM2PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        chooseCandidateColorLabel.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        candidateColorPanel.setBackground(new Color(255, 255, 255));
        candidateColorPanel.setBorder(BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));

        GroupLayout candidateColorPanelLayout = new GroupLayout(candidateColorPanel);
        candidateColorPanel.setLayout(candidateColorPanelLayout);
        candidateColorPanelLayout.setHorizontalGroup(
            candidateColorPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 41, Short.MAX_VALUE)
        );
        ...
        chooseCandidateColorPanel.setLayout(new GridLayout(2, 5, 1, 1));
        ...
        GroupLayout chooseCandidateColor0PanelLayout = new GroupLayout(chooseCandidateColor0Panel);
        chooseCandidateColor0Panel.setLayout(chooseCandidateColor0PanelLayout);
        chooseCandidateColor0PanelLayout.setHorizontalGroup(
            chooseCandidateColor0PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor2PanelLayout = new GroupLayout(chooseCandidateColor2Panel);
        chooseCandidateColor2Panel.setLayout(chooseCandidateColor2PanelLayout);
        chooseCandidateColor2PanelLayout.setHorizontalGroup(
            chooseCandidateColor2PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor4PanelLayout = new GroupLayout(chooseCandidateColor4Panel);
        chooseCandidateColor4Panel.setLayout(chooseCandidateColor4PanelLayout);
        chooseCandidateColor4PanelLayout.setHorizontalGroup(
            chooseCandidateColor4PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor6PanelLayout = new GroupLayout(chooseCandidateColor6Panel);
        chooseCandidateColor6Panel.setLayout(chooseCandidateColor6PanelLayout);
        chooseCandidateColor6PanelLayout.setHorizontalGroup(
            chooseCandidateColor6PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor8PanelLayout = new GroupLayout(chooseCandidateColor8Panel);
        chooseCandidateColor8Panel.setLayout(chooseCandidateColor8PanelLayout);
        chooseCandidateColor8PanelLayout.setHorizontalGroup(
            chooseCandidateColor8PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColorM1PanelLayout = new GroupLayout(chooseCandidateColorM1Panel);
        ...
        chooseCandidateColorM1PanelLayout.setHorizontalGroup(
            chooseCandidateColorM1PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor1PanelLayout = new GroupLayout(chooseCandidateColor1Panel);
        chooseCandidateColor1Panel.setLayout(chooseCandidateColor1PanelLayout);
        chooseCandidateColor1PanelLayout.setHorizontalGroup(
            chooseCandidateColor1PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor3PanelLayout = new GroupLayout(chooseCandidateColor3Panel);
        chooseCandidateColor3Panel.setLayout(chooseCandidateColor3PanelLayout);
        chooseCandidateColor3PanelLayout.setHorizontalGroup(
            chooseCandidateColor3PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor5PanelLayout = new GroupLayout(chooseCandidateColor5Panel);
        chooseCandidateColor5Panel.setLayout(chooseCandidateColor5PanelLayout);
        chooseCandidateColor5PanelLayout.setHorizontalGroup(
            chooseCandidateColor5PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor7PanelLayout = new GroupLayout(chooseCandidateColor7Panel);
        chooseCandidateColor7Panel.setLayout(chooseCandidateColor7PanelLayout);
        chooseCandidateColor7PanelLayout.setHorizontalGroup(
            chooseCandidateColor7PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColor9PanelLayout = new GroupLayout(chooseCandidateColor9Panel);
        chooseCandidateColor9Panel.setLayout(chooseCandidateColor9PanelLayout);
        chooseCandidateColor9PanelLayout.setHorizontalGroup(
            chooseCandidateColor9PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
        ...
        GroupLayout chooseCandidateColorM2PanelLayout = new GroupLayout(chooseCandidateColorM2Panel);
        ...
        chooseCandidateColorM2PanelLayout.setHorizontalGroup(
            chooseCandidateColorM2PanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 18, Short.MAX_VALUE)
        );
...
//        y += chooseCandidateColorLabel.getHeight();
    ...
    public void update(SudokuSet values, SudokuSet candidates, int aktColor, int index,
        ...
        if (aktColor == -1) {
            ...
            if (singleCell) {
                toggleCandidatesLabel.setText(ResourceBundle.getBundle("main/resources/intl/CellZoomPanel").getString("CellZoomPanel.toggleCandidatesLabel.text"));
                for (int i = 0; i < toggleCandidatesButtons.length; i++) {
                    toggleCandidatesButtons[i].setEnabled(true);
                }
            } else {
                toggleCandidatesLabel.setText(ResourceBundle.getBundle("main/resources/intl/CellZoomPanel").getString("CellZoomPanel.toggleCandidatesLabel.text2"));
            }
        } else {
            // coloring
...
//        //button.setText(" ");
//        Image main.resources.img = new BufferedImage(10, 10, BufferedImage.TYPE_INT_RGB);
//        Graphics g = main.resources.img.getGraphics();
//        g.setColor(color);
//        g.fillRect(0, 0, 10, 10);
//        button.setIcon(new ImageIcon(main.resources.img));
