...
public class Chain implements Cloneable, Serializable {
     ...
     *  complex chains a penalty for the complex nodes is added (see {@link #calculateLength(List)}).
...
//        newChain.chain = chain.clone();
    ...
    /**
     * Convenience method, delegates to {@link #getLength(List)}.
     * @return
     */
...
//        System.out.println("   " + toString(entry));
     ...
     * can see the complete node. Delegates to {@link #getSNodeBuddies(int, int, List, SudokuSetBase)}.
     * @param index
     * @param set
     * @param alses
     */
