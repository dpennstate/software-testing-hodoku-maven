...
//        }
        if (sourceOverlay == null) {
            // not loaded -> do it
            try {
                sourceOverlay = ImageIO.read(getClass().getResource("/main/resources/img/ov078.png"));
...
//    }
    ...
    // Danny: Note I removed the higherQuality param comment that used to exist above because it didn't exist anymore
    // in the method.
