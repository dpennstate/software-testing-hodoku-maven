...
public class ConfigFindAllStepsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        fishTypeLabel = new JLabel();
        fishTypeComboBox = new JComboBox();
        fishFromLabel = new JLabel();
        fishFromComboBox = new JComboBox();
        fishToLabel = new JLabel();
        fishToComboBox = new JComboBox();
        fishMaxFinsLabel = new JLabel();
        fishMaxFinsComboBox = new JComboBox();
        fishMaxEndoFinsLabel = new JLabel();
        fishMaxEndoFinsComboBox = new JComboBox();
        fishCheckTemplatesCheckBox = new JCheckBox();
        fishCandidatesLabel = new JLabel();
        fishCandidatesResultLabel = new JLabel();
        fishCandidatesButton = new JButton();
        krakenFishPanel = new JPanel();
        krakenFishMaxEndoFinsComboBox = new JComboBox();
        krakenFishMaxEndoFinsLabel = new JLabel();
        krakenFishMaxFinsLabel = new JLabel();
        krakenFishMaxFinsComboBox = new JComboBox();
        krakenFishFromLabel = new JLabel();
        krakenFishFromComboBox = new JComboBox();
        krakenFishToLabel = new JLabel();
        krakenFishToComboBox = new JComboBox();
        krakenFishTypeComboBox = new JComboBox();
        krakenFishTypeLabel = new JLabel();
        krakenFishCandidatesLabel = new JLabel();
        krakenFishCandidatesResultLabel = new JLabel();
        krakenFishCandidatesButton = new JButton();
        alsPanel = new JPanel();
        alsChainLengthLabel = new JLabel();
        alsChainLengthComboBox = new JComboBox();
        alsBiDirCheckBox = new JCheckBox();

        resetButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.resetButton.mnemonic").charAt(0));
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel"); // NOI18N
        ...
        fishPanel.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.fishPanel.border"))); // NOI18N

        fishCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishCheckBox.mnemonic").charAt(0));
        fishCheckBox.setText(bundle.getString("ConfigFindAllStepsPanel.fishCheckBox.text")); // NOI18N

        fishTypeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishTypeLabel.mnemonic").charAt(0));
        ...
        fishTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        fishFromLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishFromLabel.mnemonic").charAt(0));
        ...
        fishFromComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        fishToLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishToLabel.mnemonic").charAt(0));
        ...
        fishToComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        fishMaxFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishMaxFinsLabel.mnemonic").charAt(0));
        ...
        fishMaxFinsComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        fishMaxEndoFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishMaxEndoFinsLabel.mnemonic").charAt(0));
        ...
        fishMaxEndoFinsComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        fishCheckTemplatesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.fishCheckTemplatesCheckBox.mnemonic").charAt(0));
        ...
        GroupLayout fishPanelLayout = new GroupLayout(fishPanel);
        fishPanel.setLayout(fishPanelLayout);
        fishPanelLayout.setHorizontalGroup(
            fishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(fishPanelLayout.createSequentialGroup()
                .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(fishPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(fishPanelLayout.createSequentialGroup()
                                .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    .addComponent(fishFromComboBox, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(fishMaxFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(fishMaxEndoFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        fishPanelLayout.linkSize(SwingConstants.HORIZONTAL, new java.awt.Component[] {fishMaxEndoFinsComboBox, fishMaxFinsComboBox});
        ...
        fishPanelLayout.setVerticalGroup(
            ...
            .addGroup(fishPanelLayout.createSequentialGroup()
                .addComponent(fishCheckBox)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(fishTypeLabel)
                    .addComponent(fishTypeComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(fishFromLabel)
                    .addComponent(fishFromComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(fishToLabel)
                    .addComponent(fishToComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(fishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(fishMaxFinsLabel)
                    .addComponent(fishMaxFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        ...
        krakenFishPanel.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.krakenFishPanel.border"))); // NOI18N

        krakenFishMaxEndoFinsComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        krakenFishMaxEndoFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.krakenFishMaxEndoFinsLabel.mnemonic").charAt(0));
        ...
        krakenFishMaxFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.krakenFishMaxFinsLabel.mnemonic").charAt(0));
        ...
        krakenFishMaxFinsComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        krakenFishFromLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.krakenFishFromLabel.mnemonic").charAt(0));
        ...
        krakenFishFromComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        krakenFishToComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        krakenFishTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        krakenFishTypeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.krakenFishTypeLabel.mnemonic").charAt(0));
        ...
        GroupLayout krakenFishPanelLayout = new GroupLayout(krakenFishPanel);
        krakenFishPanel.setLayout(krakenFishPanelLayout);
        krakenFishPanelLayout.setHorizontalGroup(
            krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(krakenFishPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(krakenFishPanelLayout.createSequentialGroup()
                        .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(krakenFishPanelLayout.createSequentialGroup()
                                .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    .addComponent(krakenFishFromComboBox, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(krakenFishMaxFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(krakenFishMaxEndoFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        krakenFishPanelLayout.linkSize(SwingConstants.HORIZONTAL, new java.awt.Component[] {krakenFishMaxEndoFinsComboBox, krakenFishMaxFinsComboBox});

        krakenFishPanelLayout.setVerticalGroup(
            krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(krakenFishPanelLayout.createSequentialGroup()
                .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(krakenFishTypeLabel)
                    .addComponent(krakenFishTypeComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(krakenFishFromLabel)
                    .addComponent(krakenFishFromComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(krakenFishToLabel)
                    .addComponent(krakenFishToComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(krakenFishPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(krakenFishMaxFinsLabel)
                    .addComponent(krakenFishMaxFinsComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        ...
        alsPanel.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.alsPanel.border.title"))); // NOI18N

        alsChainLengthLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.alsChainLengthLabel.mnemonic").charAt(0));
        ...
        alsChainLengthComboBox.setModel(new DefaultComboBoxModel(new String[] { "4", "5", "6", "7" }));

        alsBiDirCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigFindAllStepsPanel").getString("ConfigFindAllStepsPanel.alsBiDirCheckBox.mnemonic").charAt(0));
        alsBiDirCheckBox.setText(bundle.getString("ConfigFindAllStepsPanel.alsBiDirCheckBox.text")); // NOI18N

        GroupLayout alsPanelLayout = new GroupLayout(alsPanel);
        alsPanel.setLayout(alsPanelLayout);
        alsPanelLayout.setHorizontalGroup(
            alsPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(alsPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(alsChainLengthLabel)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(alsChainLengthComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        alsPanelLayout.setVerticalGroup(
            ...
            .addGroup(alsPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(alsPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(alsChainLengthLabel)
                    .addComponent(alsChainLengthComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(alsBiDirCheckBox))
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(alsPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(10, 10, 10))
                    .addComponent(krakenFishPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(fishPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(0, 0, 0))
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)).addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(fishPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(krakenFishPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(alsPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
...
private void krakenFishCandidatesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_krakenFishCandidatesButtonActionPerformed
    ...
    public void buildTree() {
        ...
        for (int i = 0; i < steps.length; i++) {
            ...
            // Danny: Fixed Enumation Error Here
            @SuppressWarnings("unchecked")
