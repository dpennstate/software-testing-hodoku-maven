...
public class ConfigGeneralPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2 = new JPanel();
        showCandidatesCheckBox = new JCheckBox();
        showWrongValuesCheckBox = new JCheckBox();
        showDeviationsCheckBox = new JCheckBox();
        saveWindowLayoutCheckBox = new JCheckBox();
        ...
        showColorKuCheckBox = new JCheckBox();
        defaultSizeCheckBox = new JCheckBox();
        resetButton = new JButton();
        jPanel4 = new JPanel();
        shiftKeyCheckBox = new JCheckBox();
        onlySmallCursorsCheckBox = new JCheckBox();
        colorValuesCheckBox = new JCheckBox();
        showSudokuSolvedCheckBox = new JCheckBox();
        deleteCursorAfterCheckBox = new JCheckBox();
        deleteCursorAfterMsTextField = new JTextField();
        jLabel1 = new JLabel();
        toggleFilterAndOrCheckBox = new JCheckBox();
        alternativeMouseModeCheckBox = new JCheckBox();
        onlySmallFiltersCheckBox = new JCheckBox();
        editModeAutoAdvanceCheckBox = new JCheckBox();
        drawExtraBoxesCheckBox = new JCheckBox();

        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel"); // NOI18N
        jPanel2.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigGeneralPanel.jPanel2.border.title"))); // NOI18N

        showCandidatesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.showCandidatesCheckBox.mnemonic").charAt(0));
        showCandidatesCheckBox.setText(bundle.getString("ConfigGeneralPanel.showCandidatesCheckBox.text")); // NOI18N
        showCandidatesCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        showCandidatesCheckBox.setMargin(new Insets(0, 0, 0, 0));

        showWrongValuesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.showWrongValuesCheckBox.mnemonic").charAt(0));
        showWrongValuesCheckBox.setText(bundle.getString("ConfigGeneralPanel.showWrongValuesCheckBox.text")); // NOI18N
        showWrongValuesCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        showWrongValuesCheckBox.setMargin(new Insets(0, 0, 0, 0));

        showDeviationsCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.showDeviationsCheckBox.mnemonic").charAt(0));
        showDeviationsCheckBox.setText(bundle.getString("ConfigGeneralPanel.showDeviationsCheckBox.text")); // NOI18N
        showDeviationsCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        showDeviationsCheckBox.setMargin(new Insets(0, 0, 0, 0));

        saveWindowLayoutCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.saveWindowLayoutCheckBox.mnemonic").charAt(0));
        saveWindowLayoutCheckBox.setText(bundle.getString("ConfigGeneralPanel.saveWindowLayoutCheckBox.text")); // NOI18N
        saveWindowLayoutCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        saveWindowLayoutCheckBox.setMargin(new Insets(0, 0, 0, 0));

        localLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.localLabel.mnemonic").charAt(0));
        localLabel.setLabelFor(localComboBox);
        localLabel.setText(bundle.getString("ConfigGeneralPanel.localLabel.text")); // NOI18N

        lookAndFeelLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.lookAndFeelLabel.mnemonic").charAt(0));
        ...
        fontSizeLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.fontSizeLabel.mnemonic").charAt(0));
        ...
        showColorKuCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.showColorKuCheckBox.mnemonic").charAt(0));
        showColorKuCheckBox.setText(bundle.getString("ConfigGeneralPanel.showColorKuCheckBox.text")); // NOI18N
        showColorKuCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        showColorKuCheckBox.setMargin(new Insets(0, 0, 0, 0));

        defaultSizeCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.defaultSizeCheckBox.mnemonic").charAt(0));
        defaultSizeCheckBox.setText(bundle.getString("ConfigGeneralPanel.defaultSizeCheckBox.text")); // NOI18N
        defaultSizeCheckBox.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        defaultSizeCheckBox.setMargin(new Insets(0, 0, 0, 0));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(fontSizeTextField, GroupLayout.PREFERRED_SIZE, 55, GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(localLabel)
                    .addComponent(localComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(lookAndFeelLabel)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(fontSizeLabel)
                    .addComponent(fontSizeTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(showCandidatesCheckBox)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(showWrongValuesCheckBox)
        ...
        resetButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.resetButton.mnemonic").charAt(0));
        ...
        jPanel4.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigGeneralPanel.jPanel4.border.title"))); // NOI18N

        shiftKeyCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.shiftKeyCheckBox.mnemonic").charAt(0));
        shiftKeyCheckBox.setText(bundle.getString("ConfigGeneralPanel.shiftKeyCheckBox.text")); // NOI18N

        onlySmallCursorsCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.onlySmallCursorsCheckBox.mnemonic").charAt(0));
        onlySmallCursorsCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallCursorsCheckBox.text")); // NOI18N

        colorValuesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.colorValuesCheckBox.mnemonics").charAt(0));
        colorValuesCheckBox.setText(bundle.getString("ConfigGeneralPanel.colorValuesCheckBox.text")); // NOI18N

        showSudokuSolvedCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.showSudokuSolvedCheckBox.mnemonic").charAt(0));
        showSudokuSolvedCheckBox.setText(bundle.getString("ConfigGeneralPanel.showSudokuSolvedCheckBox.text")); // NOI18N

        deleteCursorAfterCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.deleteCursorAfterCheckBox.mnemonic").charAt(0));
        ...
        toggleFilterAndOrCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.toggleFilterAndOrCheckBox.mnemonic").charAt(0));
        toggleFilterAndOrCheckBox.setText(bundle.getString("ConfigGeneralPanel.toggleFilterAndOrCheckBox.text")); // NOI18N

        alternativeMouseModeCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.alternativeMouseModeCheckBox.mnemonic").charAt(0));
        alternativeMouseModeCheckBox.setText(bundle.getString("ConfigGeneralPanel.alternativeMouseModeCheckBox.text")); // NOI18N

        onlySmallFiltersCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.onlySmallFiltersCheckBox.mnemonic").charAt(0));
        onlySmallFiltersCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallFiltersCheckBox.text")); // NOI18N

        editModeAutoAdvanceCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.editModeAutoAdvanceCheckBox.mnemonic").charAt(0));
        editModeAutoAdvanceCheckBox.setText(bundle.getString("ConfigGeneralPanel.editModeAutoAdvanceCheckBox.text")); // NOI18N

        drawExtraBoxesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("ConfigGeneralPanel.drawExtraBoxesCheckBox.mnemonic").charAt(0));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addComponent(deleteCursorAfterMsTextField, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(deleteCursorAfterMsTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(alternativeMouseModeCheckBox)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.linkSize(SwingConstants.VERTICAL, new Component[] {jPanel2, jPanel4});
    ...
    public void okPressed() {
        ...
        if ((! Options.getInstance().isUseDefaultFontSize() && (oldUseDefaultFontSize || oldFontSize != Options.getInstance().getCustomFontSize())) ||
            ...
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("GeneralConfigPanel.restart_program2"));
        }
        
        language = availableIsoLanguages.get(localComboBox.getSelectedIndex());
        if (! language.equals(Options.getInstance().getLanguage())) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("GeneralConfigPanel.restart_program"));
        }
...
//                }
    ...
    private void initAll(boolean setDefault) {
        ...
        localComboBox.addItem(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("GeneralConfigPanel.automatic"));
        int languageIndex = 0;
    ...
    private void initLafs() {
        ...
        availableLafs.add(ResourceBundle.getBundle("main/resources/intl/ConfigGeneralPanel").getString("GeneralConfigPanel.system_default"));
