...
public class ConfigGeneratorPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        numberOfGivensTextField = new JTextField();
        jPanel2 = new JPanel();
        resetButton = new JButton();
        jLabelPattern = new JLabel();
        jComboBoxPatterns = new JComboBox();
        jButtonNew = new JButton();
        jButtonLoad = new JButton();
        jButtonSave = new JButton();
        jButtonChangeName = new JButton();
        jButtonCheckPattern = new JButton();

        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel"); // NOI18N
        generatorPatternPanel1.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigGeneratorPanel.generatorPatternPanel1.border.title"))); // NOI18N

        GroupLayout generatorPatternPanel1Layout = new GroupLayout(generatorPatternPanel1);
        generatorPatternPanel1.setLayout(generatorPatternPanel1Layout);
        generatorPatternPanel1Layout.setHorizontalGroup(
            generatorPatternPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        numberOfGivensTextField.setHorizontalAlignment(JTextField.CENTER);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(numberOfGivensTextField, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE))
                    .addComponent(generatorPatternPanel1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(numberOfGivensTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap(178, Short.MAX_VALUE))
        );

        resetButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.resetButton.mnemonic").charAt(0));
        ...
        jLabelPattern.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jLabelPattern.mnemonic").charAt(0));
        ...
        jButtonNew.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jButtonNew.mnemonic").charAt(0));
        ...
        jButtonLoad.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jButtonLoad.mnemonic").charAt(0));
        ...
        jButtonSave.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jButtonSave.mnemonic").charAt(0));
        ...
        jButtonChangeName.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jButtonChangeName.mnemonic").charAt(0));
        ...
        jButtonCheckPattern.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.jButtonCheckPattern.mnemonic").charAt(0));
        ...
        jPanel2Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {jButtonChangeName, jButtonCheckPattern, jButtonLoad, jButtonNew, jButtonSave});

        // Danny: Fixed Group Error Here
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)).addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelPattern)
                    .addComponent(jComboBoxPatterns, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jButtonNew)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButtonChangeName)
...
//        System.out.println("name: " + jComboBoxPatterns.getSelectedItem());
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        String defaultName = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.pattern") +
                " " + (patterns.size() + 1);
        String name = JOptionPane.showInputDialog(jButtonNew, 
                java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.patternname"),
                defaultName);
        if (name != null) {
    ...
    private void jButtonChangeNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangeNameActionPerformed
        ...
        String name = JOptionPane.showInputDialog(jButtonChangeName, 
                java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.changepatternname"),
                defaultName);
        if (name != null) {
...
private void jButtonLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoadActionPerformed
    String extension = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.extension");
    String description = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.description");
...
private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
    ...
    private void fillCombo(int index) {
        ...
        jComboBoxPatterns.addItem(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigGeneratorPanel").getString("ConfigGeneratorPanel.nopattern"));
    ...
    // Danny: Removed dest param in comment above because it is no longer used
