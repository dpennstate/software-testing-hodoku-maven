 ...
 * @author  hobiwan
 */
public class ConfigProgressPanel extends JPanel
implements ListDragAndDropChange {
    ...
    private void initComponents() {
        ...
        sstsButton = new JButton();
        mediumButton = new JButton();
        mediumPlusHardButton = new JButton();
        jPanel4 = new JPanel();
        ...
        upButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.upButton.mnemonic").charAt(0));
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel"); // NOI18N
        ...
        downButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.downButton.mnemonic").charAt(0));
        ...
        resetButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.resetButton.mnemonic").charAt(0));
        ...
        sstsButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.sstsButton.mnemonic").charAt(0));
        ...
        mediumButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.mediumButton.mnemonic").charAt(0));
        ...
        mediumPlusHardButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.mediumPlusHardButton.mnemonic").charAt(0));
        ...
        jPanel1Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {downButton, upButton});

        jPanel1Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {mediumButton, mediumPlusHardButton, resetButton, sstsButton});
        ...
        jPanel4.add(stepScrollPane, BorderLayout.CENTER);

        listButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/listview16b.png"))); // NOI18N
        ...
        treeButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/treeview16b.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE))
                .addContainerGap()))
        );
    ...
    /**
     * Sets all steps for SSTS (including the correct index). {@link SolutionType SolutionTypes}
     * that cannot be set, are collected in {@link #invalidTypes}.
     */
    // Danny: Fixed typo for the link. Was SolutionTyp, but changed to SolutionType
    ...
    private void checkSteps() {
        if (invalidTypes.size() > 0) {
            ...
            JOptionPane.showMessageDialog(this,
                    ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.techniques") +
                    buffer.toString(),
                    ResourceBundle.getBundle("main/resources/intl/ConfigProgressPanel").getString("ConfigProgressPanel.error"),
