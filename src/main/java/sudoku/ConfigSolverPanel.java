 ...
 * @author  hobiwan
 */
public class ConfigSolverPanel extends JPanel
implements ListDragAndDropChange {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel"); // NOI18N
        jPanel3.setBorder(BorderFactory.createTitledBorder(bundle.getString("ConfigSolverPanel.jPanel3.border.title"))); // NOI18N

        levelLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.levelLabel.mnemonic").charAt(0));
        levelLabel.setLabelFor(levelComboBox);
        levelLabel.setText(bundle.getString("ConfigSolverPanel.levelLabel.text")); // NOI18N

        scoreLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.scoreLabel.mnemonic").charAt(0));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(scoreTextField, GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
        ...
        upButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.upButton.mnemonic").charAt(0));
        ...
        downButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.downButton.mnemonic").charAt(0));
        ...
        resetButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.resetButton.mnemonic").charAt(0));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)).addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
    ...
    class MyDocumentListener implements DocumentListener {
        ...
        private void update(DocumentEvent e) {
            ...
            try {
                ...
                MessageFormat formatter = new MessageFormat(java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel.invalid_value").getString("MainFrame.invalid_filename"));
                String msg = formatter.format(new Object[] { txt });
                JOptionPane.showMessageDialog(null, msg,
                        java.util.ResourceBundle.getBundle("main/resources/intl/ConfigSolverPanel").getString("ConfigSolverPanel.invalid_input"), JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}
