...
//    private boolean krakenFish;
    ...
    public void run() {
        ...
        while (! Thread.interrupted()) {
            switch (actStep) {
                case 0:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.simple_solutions"), actStep);
                ...
                case 9:
                    ...
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.fish") + " " + actStep, actStep);
                ...
                case 18:
                    ...
                    if (isAllStepsEnabled(SolutionType.KRAKEN_FISH) && 
                        ...
                        updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.kraken_fish") + " " + (actStep - 9), actStep);
                    ...
                    break;
                case 19:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.uniqueness"), actStep);
                    ...
                    break;
                case 20:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.chains"), actStep);
                    ...
                    break;
                case 21:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.nice_loops"), actStep);
                    ...
                    break;
                case 22:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.grouped_nice_loops"), actStep);
                    ...
                    break;
                case 23:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.templates"), actStep);
                    ...
                    break;
                case 24:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.als"), actStep);
                ...
                case 25:
                    if (isAllStepsEnabled(SolutionType.FORCING_CHAIN)) {
                        updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.forcing_Chains"), actStep);
                ...
                case 26:
                    if (isAllStepsEnabled(SolutionType.FORCING_NET)) {
                        updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.forcing_Nets"), actStep);
                        steps1 = stepFinder.getAllForcingNets(sudoku);
                        steps.addAll(steps1);
                    }
                    break;
                case 27:
                    updateProgress(java.util.ResourceBundle.getBundle("main/resources/intl/FindAllStepsProgressDialog").getString("FindAllStepsProgressDialog.progress_Score"), actStep);
