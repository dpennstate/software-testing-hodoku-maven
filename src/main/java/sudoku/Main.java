...
public class Main {
    ...
    public String getSrcDir() {
        String path = getClass().getClassLoader().getResource("main/java/sudoku").toExternalForm().toLowerCase();
...
//        rootLogger.setLevel(Level.ALL);
        ...
        if (path == null) {
            URL startURL = Main.class.getResource("/main/java/sudoku/Main.class");
...
//    }
    ...
    // Danny: For above, changed "Option" param to "option" param to match below param
    ...
    private static void printHelpScreen() {
        System.out.println("Usage: java -Xmx512m -jar hodoku.jar [options] [puzzle]\r\n"
                + "\r\n"
                + "Options:\r\n"
                + "  /h, /?: print this main.resources.help screen\r\n"
