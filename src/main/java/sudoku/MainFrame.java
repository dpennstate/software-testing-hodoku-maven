...
//    public static final String BUILD = "Build 16";
    ...
    public static final String REV = "$LastChangedRevision: 126 $";
    ...
    private Icon emptyToggleButtonIconOrg = new ImageIcon(getClass().getResource("/main/resources/img/f_0c.png"));
...
//    private Icon emptyToggleButtonIcon = emptyToggleButtonIconOrg;
    ...
    private String configFileExt = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.config_file_ext");
    private String solutionFileExt = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_ext");
    private String textFileExt = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.text_file_ext");
    private String ssFileExt = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.ss_file_ext");
...
//        }
        ...
        statusLabelModus.setText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.playingMenuItem.text"));
...
//        }
        ...
        tabPane.addTab(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.summary"), summaryPanel);
        tabPane.addTab(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_path"), solutionPanel);
        tabPane.addTab(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.all_steps"), allStepsPanel);
        tabPane.addTab(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.cell_zoom"), cellZoomPanel);
        ...
        for (int i = 0, lim = toggleButtons.length; i < lim; i++) {
            ...
            if (i < 9) {
                emptyToggleButtonIconsOrg[i] = new ImageIcon(getClass().getResource("/main/resources/img/f_" + (i + 1) + "c_inactive.png"));
            } else {
...
//        System.out.println("List.foreground = " + bg);
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/MainFrame"); // NOI18N
        ...
        jPanel1.setLayout(new FlowLayout(FlowLayout.CENTER, 1, 0));
        ...
        progressLabel.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/invalid20.png"))); // NOI18N
        ...
        undoToolButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/undo.png"))); // NOI18N
        ...
        redoToolButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/redo.png"))); // NOI18N
        ...
        neuesSpielToolButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/hodoku02-32.png"))); // NOI18N
        ...
        redGreenToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/rgDeselected1.png"))); // NOI18N
        ...
        redGreenToggleButton.setSelectedIcon(new ImageIcon(getClass().getResource("/main/resources/img/rgSelected1.png"))); // NOI18N
        ...
        f1ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_1c.png"))); // NOI18N
        ...
        f2ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_2c.png"))); // NOI18N
        ...
        f3ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_3c.png"))); // NOI18N
        ...
        f4ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_4c.png"))); // NOI18N
        ...
        f5ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_5c.png"))); // NOI18N
        ...
        f6ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_6c.png"))); // NOI18N
        ...
        f7ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_7c.png"))); // NOI18N
        ...
        f8ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_8c.png"))); // NOI18N
        ...
        f9ToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_9c.png"))); // NOI18N
        ...
        fxyToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/f_xyc.png"))); // NOI18N
        ...
        hintPanel.setBorder(BorderFactory.createTitledBorder(bundle.getString("MainFrame.hintPanel.border.title"))); // NOI18N
        ...
        solveUpToButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solveUpToButton.mnemonic").charAt(0));
        ...
        hintPanelLayout.setHorizontalGroup(
            ...
            .addGroup(hintPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(hintPanelLayout.createSequentialGroup()
        ...
        hintPanelLayout.linkSize(SwingConstants.HORIZONTAL, new Component[] {hinweisAbbrechenButton, hinweisAusfuehrenButton, neuerHinweisButton, solveUpToButton});
        ...
        hintPanelLayout.linkSize(SwingConstants.VERTICAL, new Component[] {hinweisAbbrechenButton, hinweisAusfuehrenButton, neuerHinweisButton, solveUpToButton});

        outerSplitPane.setRightComponent(hintPanel);

        getContentPane().add(outerSplitPane, BorderLayout.CENTER);

        dateiMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.dateiMenuMnemonic").charAt(0));
        ...
        neuMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.neuMenuItemMnemonic").charAt(0));
        ...
        loadPuzzleMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.loadMenuItemMnemonic").charAt(0));
        ...
        savePuzzleMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.savePuzzleMenuItem.mnemonic").charAt(0));
        ...
        savePuzzleAsMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.saveAsMenuItemMnemonic").charAt(0));
        ...
        loadConfigMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.loadConfigMenuItem.mnemonic").charAt(0));
        ...
        saveConfigAsMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.saveConfigAsMenuItem.mnemonic").charAt(0));
        ...
        seiteEinrichtenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.seiteEinrichtenMenuItemMnemonic").charAt(0));
        ...
        druckenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.druckenMenuItemMnemonic").charAt(0));
        ...
        extendedPrintMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.extendedPrintMenuItem.mnemonic").charAt(0));
        ...
        speichernAlsBildMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.speichernAlsBildMenuItemMnemonic").charAt(0));
        ...
        spielEingebenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.spielEingebenMenuItemMnemonic").charAt(0));
        ...
        spielEditierenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("spielEditierenMenuItemMnemonic").charAt(0));
        ...
        spielSpielenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.spielenMenuItemMnemonic").charAt(0));
        ...
        beendenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.beendenMenuItemMnemonic").charAt(0));
        ...
        bearbeitenMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.bearbeitenMenuMnemonic").charAt(0));
        ...
        undoMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.undoMenuItemMnemonic").charAt(0));
        ...
        redoMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.redoMenuItemMnemonic").charAt(0));
        ...
        copyCluesMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copyCluesMenuItemMnemonic").charAt(0));
        ...
        copyFilledMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copyFilledMenuItemMnemonic").charAt(0));
        ...
        copyPmGridMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copyPmGridMenuItemMnemonic").charAt(0));
        ...
        copyPmGridWithStepMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copyPmGridWithStepMenuItemMnemonic").charAt(0));
        ...
        copyLibraryMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copyLibraryMenuItemMnemonic").charAt(0));
        ...
        copySSMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.copySSMenuItem.mnemonic").charAt(0));
        ...
        pasteMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.pasteMenuItemMnemonic").charAt(0));
        ...
        restartSpielMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.restartSpielMenuItemMnemonic").charAt(0));
        ...
        resetSpielMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.resetSpielMenuItemMnemonic").charAt(0));
        ...
        configMenuItem.setAccelerator(KeyStroke.getKeyStroke(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.configMenuItemAccelerator")));
        configMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.configMenuItemMnemonic").charAt(0));
        ...
        modeMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.modeMenu.mnemonic").charAt(0));
        modeMenu.setText(bundle.getString("MainFrame.modeMenu.text")); // NOI18N

        modeButtonGroup.add(playingMenuItem);
        playingMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.playingMenuItem.mnemonic").charAt(0));
        ...
        learningMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.learningMenuItem.mnemonic").charAt(0));
        ...
        practisingMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.practisingMenuItem.mnemonic").charAt(0));
        ...
        optionenMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.optionenMenuMnemonic").charAt(0));
        optionenMenu.setText(bundle.getString("MainFrame.optionenMenu.text")); // NOI18N

        showCandidatesMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showCandidatesMenuItemMnemonic").charAt(0));
        ...
        showWrongValuesMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showWrongValuesMenuItemMnemonic").charAt(0));
        ...
        showDeviationsMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showDeviationsMenuItemMnemonic").charAt(0));
        ...
        showColorKuMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showColorKuMenuItem.mnemonic").charAt(0));
        ...
        colorCellsMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.colorCellsMenuItem.mnemonic").charAt(0));
        ...
        colorCandidatesMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.colorCandidatesMenuItem.mnemonic").charAt(0));
        ...
        levelMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.levelMenuMnemonic").charAt(0));
        ...
        raetselMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.raetselMenuMnemonic").charAt(0));
        ...
        vageHintMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.vageHintMenuItemMnemonic").charAt(0));
        ...
        mediumHintMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.mediumHintMenuItemMnemonic").charAt(0));
        ...
        loesungsSchrittMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.loesungsSchrittMenuItemMnemonic").charAt(0));
        ...
        backdoorSearchMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.backdoorSearchMenuItem.mnemonic").charAt(0));
        ...
        historyMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.historyMenuItem.mnemonic").charAt(0));
        ...
        createSavePointMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.setSavePointMenuItem.mnemonic").charAt(0));
        ...
        restoreSavePointMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.restoreSavePointMenuItem.mnemonic").charAt(0));
        ...
        setGivensMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.setGivensMenuItem.mnemonic").charAt(0));
        ...
        alleHiddenSinglesSetzenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.alleHiddenSinglesSetzenMenuItemMnemonic").charAt(0));
        ...
        ansichtMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.ansichtMenuMnemonic").charAt(0));
        ansichtMenu.setText(bundle.getString("MainFrame.ansichtMenu.text")); // NOI18N

        sudokuOnlyMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift control " + ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.sudokuOnlyMenuItemMnemonic").toUpperCase().charAt(0)));
        viewButtonGroup.add(sudokuOnlyMenuItem);
        sudokuOnlyMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.sudokuOnlyMenuItemMnemonic").charAt(0));
        ...
        summaryMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift control " + ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.summaryMenuItemMnemonic").toUpperCase().charAt(0)));
        viewButtonGroup.add(summaryMenuItem);
        summaryMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.summaryMenuItemMnemonic").charAt(0));
        ...
        solutionMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift control " + ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solutionMenuItemMnemonic").toUpperCase().charAt(0)));
        viewButtonGroup.add(solutionMenuItem);
        solutionMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solutionMenuItemMnemonic").charAt(0));
        ...
        allStepsMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift control " + ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.allStepsMenuItemMnemonic").toUpperCase().charAt(0)));
        viewButtonGroup.add(allStepsMenuItem);
        allStepsMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.allStepsMenuItemMnemonic").charAt(0));
        ...
        cellZoomMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift control " + ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.cellZoomMenuItemMnemonic").toUpperCase().charAt(0)));
        viewButtonGroup.add(cellZoomMenuItem);
        cellZoomMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.cellZoomMenuItemMnemonic").charAt(0));
        ...
        showHintPanelMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showHintPanelMenuItem.mnemonic").charAt(0));
        ...
        showToolBarMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showToolBarMenuItem.mnemonic").charAt(0));
        ...
        showHintButtonsCheckBoxMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.showHintButtonsCheckBoxMenuItem.mnemonic").charAt(0));
        ...
        fullScreenMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.fullScreenMenuItem.mnemonic").charAt(0));
        ...
        resetViewMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.resetViewMenuItemMnemonic").charAt(0));
        ...
        helpMenu.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.helpMenu.mnemonic").charAt(0));
        helpMenu.setText(bundle.getString("MainFrame.helpMenu.text")); // NOI18N

        keyMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.keyMenuItem.mnemonic").charAt(0));
        ...
        userManualMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.userManualMenuItem.mnemonic").charAt(0));
        ...
        solvingGuideMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solvingGuideMenuItem.mnemonic").charAt(0));
        ...
        projectHomePageMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.projectHomePageMenuItem.mnemonic").charAt(0));
        ...
        reportErrorMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.reportErrorMenuItem.mnemonic").charAt(0));
        ...
        askQuestionMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.askQuestionMenuItem.mnemonic").charAt(0));
        ...
        aboutMenuItem.setMnemonic(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.aboutMenuItem.").charAt(0));
    ...
    private void speichernAlsBildMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_speichernAlsBildMenuItemActionPerformed
        ...
        if (dlg.isOk()) {
            ...
            if (bildFile.exists()) {
                ...
                msgf.applyPattern(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.file_exists"));
                String warning = msgf.format(args);
                String title = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hint");
    ...
    private void druckenMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_druckenMenuItemActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, ex.toString(),
                    ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void restartSpielMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_restartSpielMenuItemActionPerformed
        if (JOptionPane.showConfirmDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.start_new_game"),
                ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.start_new"),
    ...
    private void copyPmGridWithStepMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_copyPmGridWithStepMenuItemActionPerformed
        ...
        if (activeStep == null) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.no_step_selected"),
                    ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            if (sudokuPanel.getSudoku().userCandidatesEmpty()) {
                ...
                if (!sudokuPanel.getSudoku().checkUserCands()) {
                    ...
                    int ret = JOptionPane.showConfirmDialog(null,
                            ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.candidatesMissing"),
                            ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"),
...
private void spielEingebenMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_spielEingebenMenuItemActionPerformed
    ...
    if (sudokuPanel.getSolvedCellsAnz() != 0) {
        int antwort = JOptionPane.showConfirmDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.delete_sudoku"),
                ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.new_input"),
...
private void resetSpielMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_resetSpielMenuItemActionPerformed
    if (JOptionPane.showConfirmDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.reset_game"),
            ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.reset"),
            JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
        sudokuPanel.setSudoku(sudokuPanel.getSudokuString(ClipboardMode.CLUES_ONLY));
        sudokuPanel.checkProgress();
        allStepsPanel.setSudoku(sudokuPanel.getSudoku());
...
private void createSavePointMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_createSavePointMenuItemActionPerformed
    String defaultName = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.createsp.default")
            + " " + (savePoints.size() + 1);
    String name = (String) JOptionPane.showInputDialog(this,
            ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.createsp.message"),
            ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.createsp.title"),
    ...
    private void savePuzzleMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_savePuzzleMenuItemActionPerformed
        if (sudokuFileName != null) {
            try {
                ...
                JOptionPane.showMessageDialog(this, ex.toString(), ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
                sudokuFileName = null;
            }
        }
...
//            emptyToggleButtonIcon = emptyToggleButtonIconOrg;
    ...
    private void getHint(int mode) {
        if (sudokuPanel.getSudoku().isSolved()) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.already_solved"));
            return;
        }
        if (sudokuPanel.getSudoku().getStatus() == SudokuStatus.EMPTY
                || sudokuPanel.getSudoku().getStatus() == SudokuStatus.INVALID) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.invalid_puzzle"));
            return;
        }
        if (!sudokuPanel.isShowCandidates()) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.not_available"),
                    ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hint"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if (sudokuPanel.getSudoku().checkSudoku() == false) {
            JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.invalid_values_or_candidates"),
                    ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hint"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        if (mode == 0 || mode == 1) {
            ...
            if (step != null) {
                int strMode = 0;
                String msg = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.vage_hint");
                if (mode == 1) {
                    strMode = 1;
                    msg = ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.medium_hint");
                }
                JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.possible_step")
                        + step.toString(strMode), msg, JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.dont_know"),
                        ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
            }
        } else {
            if (step != null) {
                ...
                hinweisTextArea.setText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.dont_know"));
        ...
        if (newMode == GameMode.PLAYING) {
            ...
            if (techniques.isEmpty()) {
                JOptionPane.showMessageDialog(this,
                        ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.notechniques"),
                        ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
...
//                } else {
//                    formatter.applyPattern(java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.invalid_filename"));
//                    String msg = formatter.format(new Object[]{path});
//                    JOptionPane.showMessageDialog(this, msg,
//                            java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
            } catch (Exception ex2) {
                JOptionPane.showMessageDialog(this, ex2.toString(), ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
                sudokuFileName = null;
            }
            setTitleWithFile();
        }
...
//                    E73009
                ...
                formatter.applyPattern(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.invalid_filename"));
                String msg = formatter.format(new Object[]{path});
                JOptionPane.showMessageDialog(this, msg,
                        ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.error"), JOptionPane.ERROR_MESSAGE);
                sudokuFileName = null;
...
//                        }
            ...
            if (sudoku != null) {
                ...
                // no puzzle loaded
                statusLabelLevel.setText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.statusLabelLevel.text"));
            }
            if (sudokuPanel.isColorCells()) {
                colorCellsMenuItem.setSelected(true);
                statusLabelCellCandidate.setText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.statusLabelCellCandidate.text.cell"));
            } else {
                colorCandidatesMenuItem.setSelected(true);
                statusLabelCellCandidate.setText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.statusLabelCellCandidate.text.candidate"));
            }
            fixFocus();
        }
...
//        System.out.println("END DataFlavors");
    ...
    private Image getIcon() {
        URL url = getClass().getResource("/main/resources/img/hodoku02-32.png");
        //URL url = getClass().getResource("/main.resources.img/hodoku02-16.png");
    ...
    private void createProgressLabelImages() {
        try {
            progressImages[0] = new ImageIcon(getClass().getResource("/main/resources/img/invalid20.png"));
            BufferedImage overlayImage = ImageIO.read(getClass().getResource("/main/resources/img/ce1-20.png"));
...
//            vageHintToggleButton = new javax.swing.JToggleButton();
            ...
            vageHintToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/vageHint.png")));
            ...
            vageHintToggleButton.setToolTipText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.vageHintToolButton.toolTipText")); // NOI18N
...
//            concreteHintToggleButton = new javax.swing.JToggleButton();
            ...
            concreteHintToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/concreteHint.png")));
            ...
            concreteHintToggleButton.setToolTipText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.concreteHintToolButton.toolTipText")); // NOI18N
            jToolBar1.add(concreteHintToggleButton);

            showNextStepToggleButton = new JButton();
            showNextStepToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/nextHint.png")));
            ...
            showNextStepToggleButton.setToolTipText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.neuerHinweisButton.toolTipText")); // NOI18N
            showNextStepToggleButton.setVisible(false);
            jToolBar1.add(showNextStepToggleButton);

            executeStepToggleButton = new JButton();
            executeStepToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/executeHint.png")));
            ...
            executeStepToggleButton.setToolTipText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hinweisAusfuehrenButton.toolTipText")); // NOI18N
            executeStepToggleButton.setVisible(false);
            jToolBar1.add(executeStepToggleButton);

            abortStepToggleButton = new JButton();
            abortStepToggleButton.setIcon(new ImageIcon(getClass().getResource("/main/resources/img/abortHint.png")));
            ...
            abortStepToggleButton.setToolTipText(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hinweisAbbrechenButton.toolTipText")); // NOI18N
    ...
    class MyFileFilter extends FileFilter {
        ...
        public boolean accept(File f) {
            ...
            if (parts.length > 1) {
                ...
                switch (type) {
                    case 0:
                        // Configuration Files
                        if (ext.equalsIgnoreCase(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.config_file_ext"))) {
                            return true;
                        }
                        break;
                    case 1:
                        // Puzzles with Solutions
                        if (ext.equalsIgnoreCase(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_ext"))) {
                            return true;
                        }
                        break;
                    case 2:
                    ...
                    case 8:
                        ...
                        if (ext.equalsIgnoreCase(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.text_file_ext"))) {
                            return true;
                        }
                        break;
                    case 9:
                        // SimpleSudoku files
                        if (ext.equalsIgnoreCase(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.ss_file_ext"))) {
                            return true;
                        }
                        break;
                    default:
        ...
        public String getDescription() {
            switch (type) {
                case 0:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.config_file_descr");
                case 1:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr");
                case 2:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_gal");
                case 3:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_gf");
                case 4:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_pm");
                case 5:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_pms");
                case 6:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_pmg");
                case 7:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_l");
                case 8:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_text");
                case 9:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.solution_file_descr_ss");
                default:
                    return ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.unknown_file_type");
            }
        }
