...
public class MyFontChooser extends javax.swing.JDialog implements ListSelectionListener {
    ...
    static private String[] styles = {
        java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.regular"),
        java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.italic"),
        java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.bold"),
        java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.bold_italic")
    };
    /**
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser"); // NOI18N
        setTitle(bundle.getString("MyFontChooser.title")); // NOI18N

        jlSchriftart.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.jlSchriftart.mnemonic").charAt(0));
        ...
        jlSchriftschnitt.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.jlSchriftSchnitt.mnemonic").charAt(0));
        ...
        jlSchriftgrad.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.jlSchriftgrad.mnemonic").charAt(0));
        ...
        jbCancel.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.jbCancel.mnemonic").charAt(0));
        ...
        jbOK.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/MyFontChooser").getString("MyFontChooser.jbOK.mnemonic").charAt(0));
     ...
     */
    private void jbOKActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jbOKActionPerformed
        setVisible(false);
     ...
     * @param evt Auslösendes Event.
     */
    private void jbCancelActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jbCancelActionPerformed
        font = null;
        setVisible(false);
