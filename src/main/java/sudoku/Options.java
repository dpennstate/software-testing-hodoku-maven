...
public final class Options {
    ...
    // ACHTUNG: New main.java.solver steps must be added at the end of the array! The position is determined by "index"
...
//        new DifficultyLevel(DifficultyType.INCOMPLETE, 0, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.incomplete"), Color.BLACK, Color.WHITE),
//        new DifficultyLevel(DifficultyType.EASY, 600, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.easy"), Color.WHITE, Color.BLACK),
//        new DifficultyLevel(DifficultyType.MEDIUM, 1500, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.medium"), new Color(100, 255, 100), Color.BLACK),
//        new DifficultyLevel(DifficultyType.HARD, 3500, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.hard"), new Color(255, 255, 100), Color.BLACK),
//        new DifficultyLevel(DifficultyType.UNFAIR, 5000, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.unfair"), new Color(255, 150, 80), Color.BLACK),
//        new DifficultyLevel(DifficultyType.EXTREME, Integer.MAX_VALUE, java.util.ResourceBundle.getBundle("main.resources.intl/MainFrame").getString("MainFrame.extreme"), new Color(255, 100, 100), Color.BLACK)
        DEFAULT_DIFFICULTY_LEVELS[0].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.incomplete"));
        DEFAULT_DIFFICULTY_LEVELS[1].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.easy"));
        DEFAULT_DIFFICULTY_LEVELS[2].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.medium"));
        DEFAULT_DIFFICULTY_LEVELS[3].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hard"));
        DEFAULT_DIFFICULTY_LEVELS[4].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.unfair"));
        DEFAULT_DIFFICULTY_LEVELS[5].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.extreme"));
        difficultyLevels[0].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.incomplete"));
        difficultyLevels[1].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.easy"));
        difficultyLevels[2].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.medium"));
        difficultyLevels[3].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.hard"));
        difficultyLevels[4].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.unfair"));
        difficultyLevels[5].setName(ResourceBundle.getBundle("main/resources/intl/MainFrame").getString("MainFrame.extreme"));
