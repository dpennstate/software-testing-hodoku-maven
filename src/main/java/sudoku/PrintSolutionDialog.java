...
public class PrintSolutionDialog extends javax.swing.JDialog implements Printable {
    ...
    private void initComponents() {
        ...
        compressSinglesCheckBox = new JCheckBox();
        compressSSTSCheckBox = new JCheckBox();
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog"); // NOI18N
        ...
        widthLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.widthLabel.mnemonic").charAt(0));
        ...
        compressSinglesCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.compressSinglesCheckBox.mnemonic").charAt(0));
        ...
        compressSSTSCheckBox.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.compressSSTSCheckBox.mnemonic").charAt(0));
        ...
        titleLabel.setDisplayedMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.titleLabel.mnemonic").charAt(0));
        ...
        printButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.printButton.mnemonic").charAt(0));
        ...
        copyButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.copyButton.mnemonic").charAt(0));
        ...
        pageOptionsButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.pageOptionsButton.mnemonic").charAt(0));
        ...
        closeButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.closeButton.mnemonic").charAt(0));
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new Component[] {closeButton, copyButton, printButton});
    ...
    private void compressSinglesCheckBoxActionPerformed(ActionEvent evt) {//GEN-FIRST:event_compressSinglesCheckBoxActionPerformed
        stepList.repaint();
    }//GEN-LAST:event_compressSinglesCheckBoxActionPerformed

    private void compressSSTSCheckBoxActionPerformed(ActionEvent evt) {//GEN-FIRST:event_compressSSTSCheckBoxActionPerformed
    ...
    private void pageOptionsButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_pageOptionsButtonActionPerformed
        if (job == null) {
...
//        }
    ...
    private void copyToClipboard() {
        ...
        // Givens
        out.println(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.givens"));
        out.println(sudoku.getSudoku(ClipboardMode.CLUES_ONLY));
        out.println();
        // InitialState
        out.println(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.initialState"));
        ...
        for (int i = 0; i < steps.length; i++) {
            if (compressSinglesCheckBox.isSelected() && SolutionType.isSingle(steps[i].getType()) ||
                ...
                if (compressedStarted) {
                    ...
                    out.println();
                    if (isSingles) {
                        out.println(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.singlesTo"));
                    } else {
                        out.println(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.sstsTo"));
                    }
                    out.println(sudoku.getSudoku(ClipboardMode.PM_GRID));
                    compressedStarted = false;
                }
        ...
        // print the solution
        out.println();
        out.println(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.solution"));
        out.println(sudoku.getSudoku(ClipboardMode.PM_GRID));
...
//        printG2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
        ...
        if (pageIndex == 0) {
            ...
            // Givens
            y += lineHeight;
            printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.givens"), 0, y);
            ...
            y += lineHeight;
            printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.initialState"), 0, y);
            panel.setStep(null);
        ...
        for ( ; printIndex < steps.length; printIndex++) {
            if (compressSinglesCheckBox.isSelected() && SolutionType.isSingle(steps[printIndex].getType()) ||
                ...
                if (compressedStarted) {
                    ...
                    y += lineHeight / 2;
                    if (isSingles) {
                        printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.singlesTo"), 0, y);
                    } else {
                        printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.sstsTo"), 0, y);
                    }
                    panel.setStep(null);
                    BufferedImage img = panel.getSudokuImage(imagePrintSize);
                    y += lineHeight / 2;
        ...
        if (compressedStarted) {
            ...
            y += lineHeight / 2;
            if (isSingles) {
                printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.singlesToEnd"), 0, y);
            } else {
                printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.sstsToEnd"), 0, y);
            }
            compressedStarted = false;
        }
        // print the solution
        ...
        y += lineHeight;
        y += lineHeight / 2;
        printG2.drawString(ResourceBundle.getBundle("main/resources/intl/PrintSolutionDialog").getString("PrintSolutionDialog.solution"), 0, y);
        panel.setStep(null);
        BufferedImage img = panel.getSudokuImage(imagePrintSize);
        y += lineHeight / 2;
        printG2.drawImage(img, null, 0, y);
