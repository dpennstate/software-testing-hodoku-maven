...
public class RestoreSavePointDialog extends javax.swing.JDialog {
    ...
    private String[] columnNames = new String[]{
        ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.col1"),
        ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.col2")
    };
    ...
    private void initComponents() {
        ...
        savePointTable = new JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        ResourceBundle bundle = ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint"); // NOI18N
        setTitle(bundle.getString("title")); // NOI18N

        okButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.cancelButton.mnemonic").charAt(0));
        ...
        savePointTable.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void okButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (savePointTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this,
                    ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.error.message"),
                    ResourceBundle.getBundle("main/resources/intl/RestoreSavePoint").getString("RestoreSavePointDialog.error.title"),
    ...
    private void savePointTableMouseClicked(MouseEvent evt) {//GEN-FIRST:event_savePointTableMouseClicked
