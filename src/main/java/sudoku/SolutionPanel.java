...
//        solutionTabbedPane.add("Lösung 3", solutionScrollPane);
    ...
    private void initComponents() {
        ...
        deleteFromHereMenuItem = new JMenuItem();
        jSeparator1 = new JSeparator();
        toStepMenuItem = new JMenuItem();
        solveFromHereMenuItem = new JMenuItem();
        tabPopupMenu = new JPopupMenu();
        tabNewMenuItem = new JMenuItem();
        jSeparator2 = new JSeparator();
        tabNewNameMenuItem = new JMenuItem();
        tabDeleteMenuItem = new JMenuItem();
        jSeparator3 = new JSeparator();
        tabPrintMenuItem = new JMenuItem();
        titleLabel = new JLabel();
        southPanel = new JPanel();
        weiterButton = new JButton();
        alleEinfachenButton = new JButton();
        solutionTabbedPane = new JTabbedPane();
        ...
        deleteFromHereMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.deleteFromHereMenuItem.mnemonic").charAt(0));
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel"); // NOI18N
        ...
        toStepMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.toStepMenuItem.mnemonic").charAt(0));
        ...
        solveFromHereMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.solveFromHereMenuItem.mnemonic").charAt(0));
        ...
        tabNewMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.tabNewMenuItem.mnemonic").charAt(0));
        ...
        tabNewNameMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.tabNewNameMenuItem.mnemonic").charAt(0));
        ...
        tabDeleteMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.tabDeleteMenuItem.mnemonic").charAt(0));
        ...
        tabPrintMenuItem.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.tabPrintMenuItem.mnemonic").charAt(0));
        ...
        weiterButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.weiterButton.mnemonic").charAt(0));
        ...
        alleEinfachenButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.alleEinfachenButton.mnemonic").charAt(0));
        ...
        southPanelLayout.linkSize(SwingConstants.HORIZONTAL, new Component[] {alleEinfachenButton, weiterButton});

        southPanelLayout.setVerticalGroup(
            southPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(southPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(southPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(weiterButton)
                    .addComponent(alleEinfachenButton))
        ...
        solutionTabbedPane.setTabPlacement(JTabbedPane.BOTTOM);
        ...
        add(solutionTabbedPane, BorderLayout.CENTER);
...
private void tabNewNameMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabNewNameMenuItemActionPerformed
    ...
    String newTitel = JOptionPane.showInputDialog(java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.new_name"), init);
    if (newTitel != null) {
...
//        new PrintSolutionDialog(mainFrame, true, actSteps, mainFrame.getSudokuPanel().getSudoku().getSudoku(ClipboardMode.LIBRARY)).setVisible(true);
    ...
    public void addStep(SolutionStep step) {
        ...
        if (actSteps.get(actSteps.size() - 1).getType() != SolutionType.INCOMPLETE) {
            JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.cant_add_step"),
                    java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.error"),
...
//            System.out.println("   foreground: " + Options.getInstance().getDifficultyLevels()[SolutionType.getStepConfig(actSteps.get(i).getType()).getLevel()].getForegroundColor());
    ...
    private void addTabPane(List<SolutionStep> steps) {
        String titel = java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.solution") +
    ...
    private void deleteTabPane() {
        if (solutionTabbedPane.getTabCount() <= 1) {
            JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.cant_delete_step"),
                    java.util.ResourceBundle.getBundle("main/resources/intl/SolutionPanel").getString("SolutionPanel.error"),
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
