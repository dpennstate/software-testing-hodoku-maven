...
public class SolutionStep implements Comparable<SolutionStep>, Cloneable, Serializable {
    ...
    private static final String[] entityNames = {
        ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.block"),
        ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.line"),
        ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.col"),
        ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.cell")
    };
...
//                            int alsIndex = Chain.getSCellIndex2(chain[i]);
    ...
    public String getCandidateString(boolean library, boolean statistics) {
        ...
        if (library) {
            ...
            if (statistics) {
                ...
                if (isSiamese) {
                    tmpStepName = ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.siamese")
                            + " " + getStepName();
                }
    ...
    public final void setType(SolutionType type) {
        ...
        if (!found) {
            throw new RuntimeException(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.invalid_setType") + " (" + type + ")");
        }
        this.type = type;
    }
    ...
    public void addValue(int value) {
        if (value < 1 || value > 9) {
            throw new RuntimeException(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.invalid_setValue") + " (" + value + ")");
        }
        values.add(value);
    }
    ...
    public void addIndex(int index) {
        if (index < 0 || index > 80) {
            throw new RuntimeException(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.invalid_setIndex") + " (" + index + ")");
        }
        indices.add(index);
    }
    ...
    public String toString(int art) {
        ...
        switch (type) {
            ...
            case LOCKED_PAIR:
                ...
                if (art >= 2) {
                    tmp.append(" ");
                    tmp.append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in"));
                    tmp.append(" ");
            ...
            case LOCKED_CANDIDATES_2:
                ...
                if (art >= 2) {
                    str += " "
                            + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in")
            ...
            case DUAL_TWO_STRING_KITE:
                ...
                if (art >= 2) {
                    str += " " + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in") + " "
                    ...
                    str += " ("
                            + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.connected_by") + " "
            ...
            case DUAL_EMPTY_RECTANGLE:
                ...
                if (art >= 2) {
                    str += " " + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in") + " " + getEntityShortName() + getEntityNumber()
                            + " (" + getCompactCellPrint(indices, 0, 1);
            ...
            case W_WING:
                ...
                if (art >= 2) {
                    ...
                    tmp.append(" ");
                    tmp.append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.connected_by"));
                    tmp.append(" ");
                    tmp.append(values.get(1));
                    tmp.append(" ");
                    tmp.append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in"));
            ...
            case XYZ_WING:
                ...
                if (art >= 2) {
                    str += "/" + values.get(2) + " " + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in") + " " + getCompactCellPrint(indices);
                    tmp = new StringBuffer(str);
                    getCandidatesToDelete(tmp);
                    str = tmp.toString();
                }
...
//                    }
            ...
            case FORCING_NET_VERITY:
                ...
                if (art >= 2) {
                    if (type == SolutionType.FORCING_CHAIN_CONTRADICTION
                        ...
                        str += " " + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.in") + " " + getEntityShortNameNumber();
                    } else {
                        //str += " Verity";
                    }
                    if (indices.size() > 0) {
            ...
            case KRAKEN_FISH_TYPE_2:
                ...
                if (isSiamese) {
                    tmp.append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.siamese")).append(" ");
                }
            ...
            case ALS_XY_CHAIN:
                ...
                if (restrictedCommons.isEmpty()) {
                    ...
                    if (art == 1) {
                        tmp = new StringBuffer(str + ": ");
                        tmp.append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.start")).append("=");
                        getAls(tmp, 0);
                        tmp.append(", ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.end")).append("=");
            ...
            case BRUTE_FORCE:
                ...
                break;
            case INCOMPLETE:
                str = ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.incomplete_solution");
                break;
            case GIVE_UP:
                tmp = new StringBuffer();
                tmp.append(getStepName());
                if (art >= 1) {
                    tmp.append(": ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.dont_know"));
                }
                str = tmp.toString();
                break;
            default:
                throw new RuntimeException(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.invalid_type") + " (" + type + ")!");
        }
        return str;
    }
...
//        }
    ...
    /**
     * Similar to {@link #getCandidatesToDeleteDigits(StringBuffer) },
    ...
    public void getFins(StringBuffer tmp, boolean endo, boolean library) {
        ...
        if (!library) {
            if (list.size() == 1) {
                if (endo) {
                    tmp.append(" ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.endofin_in")).append(" ");
                } else {
                    tmp.append(" ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.fin_in")).append(" ");
                }
            } else {
                if (endo) {
                    tmp.append(" ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.endofins_in")).append(" ");
                } else {
                    tmp.append(" ").append(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.fins_in")).append(" ");
                }
            }
        }
    ...
    public void setEntity(int entity) {
        if (entity != Sudoku2.BLOCK && entity != Sudoku2.LINE && entity != Sudoku2.COL && entity != Sudoku2.CELL) {
            throw new RuntimeException(ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString("SolutionStep.invalid_setEntity") + " (" + entity + ResourceBundle.getBundle("main/resources/intl/SolutionStep").getString(")"));
        }
        this.entity = entity;
    }
