...
public class SummaryPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/SummaryPanel"); // NOI18N
    ...
    class SummaryTableModel extends AbstractTableModel {
        private static final long serialVersionUID = 1L;
        String[] columnNames = { java.util.ResourceBundle.getBundle("main/resources/intl/SummaryPanel").getString("SummaryPanel.count"), java.util.ResourceBundle.getBundle("main/resources/intl/SummaryPanel").getString("SummaryPanel.technique"), java.util.ResourceBundle.getBundle("main/resources/intl/SummaryPanel").getString("SummaryPanel.score") };
        Object[][] content = { { "", "", "", null } };
        ...
        public void initialize(SudokuSolver solver) {
            if (solver != null) {
                ...
                content[index][1] = java.util.ResourceBundle.getBundle("main/resources/intl/SummaryPanel").getString("SummaryPanel.sum");
