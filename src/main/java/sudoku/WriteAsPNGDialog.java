...
public class WriteAsPNGDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pixelRadioButton = new JRadioButton();
        bildSpeichernButton = new javax.swing.JButton();
        abbrechenButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog"); // NOI18N
        ...
        sizeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.sizeLabel.mnemonic").charAt(0));
        sizeLabel.setLabelFor(sizeTextField);
        sizeLabel.setText(bundle.getString("WriteAsPNGDialog.sizeLabel.text")); // NOI18N

        resolutionLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.resolutionLabel.mnemonic").charAt(0));
        ...
        mmRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.mmRadioButton.mnemonic").charAt(0));
        ...
        inchRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.inchRadioButton.mnemonic").charAt(0));
        ...
        pixelRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.pixelRadioButton.mnemonic").charAt(0));
        ...
        bildSpeichernButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.bildSpeichernButton.mnemonic").charAt(0));
        ...
        abbrechenButton.setMnemonic(java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.abbrechenButton.mnemonic").charAt(0));
    ...
    private void bildSpeichernButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_bildSpeichernButtonActionPerformed
        JFileChooser chooser = new JFileChooser(getBildFile());
        chooser.setFileFilter(new FileNameExtensionFilter(
                "*.png " + java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.files"),
                "png"));
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (!name.toLowerCase().endsWith(".png")) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.invalid_filename"),
                            java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.error"),
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.invalid_input_format"),
                        java.util.ResourceBundle.getBundle("main/resources/intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.error"),
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
